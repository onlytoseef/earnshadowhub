  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        // Conditional navigation based on role and plan status
        if (userData.role === 'admin') {
          // Admin → Admin Dashboard
          navigate('/dashboard/admin');
        } else if (userData.role === 'customer') {
          // Customer → Check plan status
          if (userData.planType && userData.planType !== 'basic') {
            // Has a paid plan → Customer Dashboard
            navigate('/dashboard/customer');
          } else {
            // No plan or basic plan → Plans Page
            navigate('/plans');
          }
        } else {
          // Default fallback
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to your EarnShadow account</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>© 2025 EarnShadow. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
